<div class="account">
	...
	<div class="row">
		<div class="col-xs-12 col-md-6">
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title">[[user:select-skin]]</h3>
				</div>
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title">[[user:select-homepage]]</h3>
				</div>
				<div class="panel-body">
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title">[[global:privacy]]</h3>
				</div>
				<div class="panel-body">
					<!-- IF !hideEmail -->
					<div class="checkbox">
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title">[[user:browsing]]</h3>
				</div>
				<div class="panel-body">
					<div class="checkbox">
						<label>
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title">[[global:pagination]]</h3>
				</div>
				<div class="panel-body">
					<div class="checkbox">
						<label>
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title">[[global:email]]</h3>
				</div>
				<div class="panel-body">
					<div class="form-group">
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title">{customSettings.title}</h3>
				</div>
				<div class="panel-body">
		...
		<div class="col-xs-12 col-md-6">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title">[[global:language]]</h3>
				</div>
				<div class="panel-body">
					<div class="row">
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title">[[topic:watch]]</h3>
				</div>
				<div class="panel-body">
					<div class="checkbox">
						<label>
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title">[[user:notifications]]</h3>
				</div>
				<div class="panel-body">
